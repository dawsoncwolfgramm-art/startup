...
- [x] **Stores data in MongoDB** - I did complete this and stores the data in mongoDB
- [x] **Stores credentials in MongoDB** - I did complete this and stores credentials in the mongoDB and makes sure to verify that they can see the scores. 
